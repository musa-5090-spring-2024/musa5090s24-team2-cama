...
opa_test <- opa_sf %>%
  select(category_code, census_tract, depth, fireplaces, frontage,
         garage_spaces, mailing_zip, number_of_bathrooms, number_of_rooms, owner_1,
         sale_date, sale_price, total_livable_area, year_built)
...
opa_test <- opa_test[!duplicated(opa_test[c("owner_1", "sale_date", "sale_price")]), ]
